...
export const FURNITURE_LIB = [
  ...
  // 网上下载的 GLB 模型（glb 字段指向 public/models/ 下的文件，h 为目标高度用于缩放）
  { type: '椅子', w: 0.5, d: 0.5, h: 0.85, glb: 'chair.glb' },
  { type: '沙发(3D)', w: 2.2, d: 0.9, h: 0.68, glb: 'sofa.glb' },
  { type: '床(3D)', w: 1.0, d: 2.0, h: 0.5, glb: 'bed.glb' },
  { type: '餐桌(3D)', w: 1.2, d: 1.2, h: 0.75, glb: 'table.glb' },
]
...
export const FURNITURE_COLORS = {
  ...
  椅子: '#9aa7b5', '沙发(3D)': '#718b80', '床(3D)': '#a58b76', '餐桌(3D)': '#a67e5f',
}
